...
{
    { { NPC_WINTERGRASP_TAUNKA_SPIRIT_GUIDE, NPC_WINTERGRASP_DWARVEN_SPIRIT_GUIDE }, GRAVEYARD_WORKSHOP_NE, WORLDSAFELOC_WINTERGRASP_SIEGE_FACTORY_DEFENSE_NE, GOSSIP_WINTERGRASP_GRAVEYARD_NE },
    { { NPC_WINTERGRASP_TAUNKA_SPIRIT_GUIDE, NPC_WINTERGRASP_DWARVEN_SPIRIT_GUIDE }, GRAVEYARD_WORKSHOP_NW, WORLDSAFELOC_WINTERGRASP_SIEGE_FACTORY_DEFENSE_NW, GOSSIP_WINTERGRASP_GRAVEYARD_NW },
    { { NPC_WINTERGRASP_TAUNKA_SPIRIT_GUIDE, NPC_WINTERGRASP_DWARVEN_SPIRIT_GUIDE }, GRAVEYARD_WORKSHOP_SE, WORLDSAFELOC_WINTERGRASP_SIEGE_FACTORY_SE,         GOSSIP_WINTERGRASP_GRAVEYARD_SE },
    { { NPC_WINTERGRASP_TAUNKA_SPIRIT_GUIDE, NPC_WINTERGRASP_DWARVEN_SPIRIT_GUIDE }, GRAVEYARD_WORKSHOP_SW, WORLDSAFELOC_WINTERGRASP_SIEGE_FACTORY_SW,         GOSSIP_WINTERGRASP_GRAVEYARD_SW },
    { { NPC_WINTERGRASP_TAUNKA_SPIRIT_GUIDE, NPC_WINTERGRASP_DWARVEN_SPIRIT_GUIDE }, GRAVEYARD_KEEP,        WORLDSAFELOC_WINTERGRASP_FORTRESS_EAST,            GOSSIP_WINTERGRASP_GRAVEYARD_KEEP },
    { { NPC_WINTERGRASP_TAUNKA_SPIRIT_GUIDE, NPC_WINTERGRASP_DWARVEN_SPIRIT_GUIDE }, GRAVEYARD_HORDE,       WORLDSAFELOC_WINTERGRASP_HORDE_STARTING_AREA,      GOSSIP_WINTERGRASP_GRAVEYARD_HORDE },
